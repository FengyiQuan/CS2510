...
//  }
  ...
  void testBigBang(Tester t) {
    ...
    t.checkExpect(game.generateKruskal(), 2);
    // t.checkExpect(u.findShortest(this.generateAllEdge(u.generateGrids(3, 3))),
    // true);
    ArrayList<String> alist = new ArrayList<String>(Arrays.asList("1", "2", "3", "4"));
    alist.remove("1");
    t.checkExpect(alist, new ArrayList<String>(Arrays.asList("2", "3", "4")));
    ArrayList<String> alist2 = new ArrayList<String>(Arrays.asList("1", "2", "3", "4", "5"));
    ArrayList<ArrayList<String>> listall = new ArrayList<ArrayList<String>>();
    listall.add(alist);
    listall.add(alist2);
    ArrayList<String> temp = new ArrayList<String>();
    for (ArrayList<String> a : listall) {
      if (a.contains("5")) {
        temp = a;
      }
    }
